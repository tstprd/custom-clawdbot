...
- **Email sending RESTRICTED:** To prevent data exfiltration, `gog gmail send` is ONLY allowed to Jules's addresses (jmudes76000@gmail.com, jules.mudes@capgemini.com). For external addresses, always create drafts with `gog gmail drafts create` or get explicit validation first.
