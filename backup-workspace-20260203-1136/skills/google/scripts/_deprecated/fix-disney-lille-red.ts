...
async function main(): Promise<void> {
  try {
    const eventId = '70p6ccr361gmcb9i6pgj0b9k6hgjib9o74oj8b9l60o34ohmc5h30cph60';
    
    // Update to red (11) + no reminders
    const update = {
      colorId: '11',  // Red
      reminders: {
        useDefault: false,
    ...
    const result = `🔴 Disney a paris puis Lille remis en rouge
