/**
 * Google OAuth for Tasks + Gmail + Calendar FOR ALEJMUROT ACCOUNT
 * Run: node skills/google/scripts/auth-tasks-alejmurot.mjs
 */
...
const authUrl = `https://accounts.google.com/o/oauth2/v2/auth?${new URLSearchParams({
  ...
  access_type: 'offline',
  prompt: 'consent',
  login_hint: 'alejmurot@gmail.com'
})}`;

console.log('\n🔐 Authentification pour alejmurot@gmail.com\n');
console.log('Ouvrez ce lien dans votre navigateur:\n');
console.log(authUrl);
console.log('\n⚠️  IMPORTANT: Sélectionnez le compte alejmurot@gmail.com\n');

// Also write to output file
writeFileSync(join(process.cwd(), 'ha-output.txt'), `🔐 Authentification Google OAuth pour alejmurot@gmail.com
...
const server = createServer(async (req, res) => {
  ...
  if (url.pathname === '/oauth2callback') {
    ...
    try {
      ...
      res.end(`
        <html>
          ...
          <body>
            ...
            <p><strong>Compte:</strong> alejmurot@gmail.com</p>
      ...
      console.log('\n✅ Tokens sauvegardés pour alejmurot@gmail.com');
