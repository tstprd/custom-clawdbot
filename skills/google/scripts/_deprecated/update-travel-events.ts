/**
 * Update travel events: red color + remove reminders
 */
...
async function main(): Promise<void> {
  try {
    let result = '🎨 Mise à jour des déplacements:\n';
    
    // Events to update
    const travelEvents = [
      {
        id: '6osj8p9n71hj6b9jc8p3ib9kcli30bb2ccqm2b9g60q64c3664s3ap1hck',
        summary: 'Disney+ Lille adeo'
      },
      {
        id: '70p6ccr361gmcb9i6pgj0b9k6hgjib9o74oj8b9l60o34ohmc5h30cph60',
        summary: 'Disney a paris puis Lille'
      }
    ];
    
    for (const event of travelEvents) {
      // Update: red color (11) + no reminders
      const update = {
        colorId: '11',  // Red
        reminders: {
          useDefault: false,
