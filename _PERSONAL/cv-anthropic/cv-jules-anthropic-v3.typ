// CV Jules Mudès - Version Anthropic v3
...
#text(fill: gray, size: 8.5pt, style: "italic")[Client : acteur majeur du retail français · 100+ sites internationaux · Équipe de 15 personnes]
#v(0.08cm)
...
#text(fill: gray, size: 8.5pt, style: "italic")[Client : acteur majeur du retail français · 2 sites France & Italie · Décommissionnement WMOS]
#v(0.08cm)
...
#text(fill: gray, size: 8.5pt, style: "italic")[Client : acteur majeur du retail français · Programme international · Déploiement de 44 entrepôts]
#v(0.08cm)
...
#text(fill: gray, size: 8.5pt, style: "italic")[Client : acteur majeur du consumer goods · Migration vers WMOS · Décommissionnement INFOLOG]
#v(0.08cm)
...
#text(fill: gray, size: 8.5pt, style: "italic")[Client : maison de luxe internationale · Entrepôt central hautement mécanisé · 4 systèmes WCS]
#v(0.08cm)
...
// Role 6
#text(fill: gray, size: 9pt, style: "italic")[2017 — 2019 : Chef de projet intégration (client luxe), pilotage des tests de recette, support au démarrage]
