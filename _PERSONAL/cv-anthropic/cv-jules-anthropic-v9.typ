// CV Jules Mudès - Version Anthropic v9
...
Architecte solutions avec 9 ans d'expérience en transformation Supply Chain, déploiement et intégration de systèmes pour des clients grands comptes français (luxe, retail, industrie). Exposé aux fonctions Finance, Contrôle de gestion et Achats par association avec la Supply Chain. Expert WMS et industrialisation — j'accélère les projets de transformation en développant des outils et frameworks réutilisables. Passionné par l'optimisation du travail des équipes : je cherche à retirer les tâches fastidieuses sans valeur ajoutée pour permettre à chacun de se concentrer sur son expertise business. J'ai créé une académie GenAI chez Capgemini pour former mes collègues via des sessions pratiques et techniques, avec un environnement dédié leur permettant d'expérimenter directement avec les outils.

#v(0.25cm)

// Context
#text(fill: gray, size: 8pt, style: "italic")[Équipe Supply Chain de ~100 consultants spécialisés · Fonctionnement agile · Exposition à de multiples environnements d'entreprise à travers les missions]
...
#text(fill: gray, size: 8pt, style: "italic")[Clients : Kiabi (retail), Chanel (mode), grande maison du luxe français · Programmes internationaux en anglais]
#v(0.06cm)
