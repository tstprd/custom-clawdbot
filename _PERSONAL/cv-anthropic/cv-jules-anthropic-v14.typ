// CV Jules Mudès - Version Anthropic v14
...
#align(center)[
  ...
  #v(0.15cm)
  #text(size: 9pt, fill: gray)[Français (natif) · Anglais (courant, projets internationaux) · Italien (notions)]
]
...
- *Domotique & IA :* Home Assistant connecté à Claude Code — surveillance consommation électrique, automatisation chauffage selon présence/absence. Utilisation de projets open-source faisant appel aux modèles LLM fournis par Anthropic pour l'automatisation quotidienne
...
#v(0.1cm)
Ingénieur Généraliste — HEI Lille (2016) #text(fill: gray, size: 8pt)[· Spécialité Conception Mécanique]
