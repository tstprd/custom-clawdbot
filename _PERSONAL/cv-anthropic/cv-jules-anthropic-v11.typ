// CV Jules Mudès - Version Anthropic v11
...
Architecte solutions avec 9 ans d'expérience en transformation Supply Chain et déploiement de systèmes d'entreprise pour des clients grands comptes français dans le luxe, le retail et l'industrie. Expert des solutions WMS et TMS, je gère la dualité IT/Business dans les projets : organisation, communication, moyens techniques, intégrations, devices et configuration des solutions. Par association, je collabore régulièrement avec les départements Finance, Contrôle de gestion et Achats.

J'interviens sur le cadrage des projets pour découvrir l'environnement et concevoir la solution dans son ensemble : architecture fonctionnelle, environnement technique IT, interactions avec les autres systèmes et impact sur les postes de travail. J'accélère les transformations en développant des outils et frameworks réutilisables, avec l'objectif de retirer les tâches répétitives pour permettre aux équipes de se concentrer sur leur expertise métier.

Passionné par les avancées technologiques, je me tiens constamment informé des nouveaux concepts et techniques pour exploiter les LLMs et l'IA. J'ai créé une académie GenAI et Agentique chez Capgemini pour former mes collègues via des sessions pratiques avec un environnement dédié à l'expérimentation.
...
- Développement d'applications avec interfaces utilisateur basées sur les APIs WMS/ERP, avec Claude
...
#grid(
  ...
  [
    *Technique*
    - Expert WMS/TMS (Manhattan, Blue Yonder)
    - Python, SQL/PL-SQL, Bash, HTML/CSS
    - Cloud : GCP, Azure, SAP
    - Développement d'apps avec APIs WMS/ERP
...
- Domotique avec Home Assistant connecté à Claude Code : scripts de surveillance de consommation électrique, automatisation du chauffage selon présence/absence
- Utilisation de projets open-source basés sur les modèles Anthropic pour l'automatisation quotidienne : lecture et tri des emails, prise de rendez-vous, gestion comptable
