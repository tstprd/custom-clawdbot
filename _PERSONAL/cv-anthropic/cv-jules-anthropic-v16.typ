// CV Jules Mudès - Version Anthropic v16
...
#align(center)[
  ...
  #text(size: 9pt, fill: gray)[
    Rennes, France (déplacement Paris régulier — 1h30 TGV)  ·  06 61 03 01 64  ·  jmudes76000\@gmail.com  ·  linkedin.com/in/jules-mudès-0a444992
  ]
]
...
Grâce à mon expertise WMS, je conçois la configuration des solutions pour implémenter les processus business. Je conseille les clients grâce à ma connaissance métier acquise au fil de mes missions chez une multitude de clients de différents secteurs.
...
#block(
  ...
  #grid(
    columns: (1fr, auto),
    text(weight: "bold")[Contributeur Avant-Vente — Team Solutionning, Practice Supply Chain],
