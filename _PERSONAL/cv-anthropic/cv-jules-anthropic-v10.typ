// CV Jules Mudès - Version Anthropic v10
...
J'accélère les transformations en développant des outils et frameworks réutilisables, avec l'objectif de retirer les tâches répétitives pour permettre aux équipes de se concentrer sur leur expertise métier. J'ai créé une académie GenAI chez Capgemini pour former mes collègues via des sessions pratiques avec un environnement dédié à l'expérimentation.
