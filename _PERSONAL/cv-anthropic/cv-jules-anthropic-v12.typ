// CV Jules Mudès - Version Anthropic v12
...
J'interviens sur le cadrage des projets pour découvrir l'environnement et concevoir la solution dans son ensemble : architecture fonctionnelle, environnement technique IT, interactions avec les autres systèmes et impact sur les postes de travail. J'accélère les transformations en développant des outils et frameworks réutilisables, avec l'objectif de réduire les tâches répétitives pour permettre aux équipes de se concentrer sur la valeur métier.

Passionné par les avancées technologiques, je me tiens constamment informé des nouveaux concepts et techniques pour exploiter les LLMs et l'IA. J'ai créé une académie GenAI et Agentic AI chez Capgemini pour former mes collègues via des sessions pratiques. L'environnement d'expérimentation que j'ai conçu permet d'appeler des LLMs et de tester des comportements agentiques avec un agent qui interagit avec des ERP/WMS — les outils que nos équipes utilisent au quotidien.
...
- Utilisation de projets open-source faisant appel aux modèles LLM fournis par Anthropic pour l'automatisation quotidienne : lecture et tri des emails, prise de rendez-vous, gestion comptable

#v(0.3cm)

// Interests
#text(size: 10pt, weight: "bold", fill: primary)[CENTRES D'INTÉRÊT]
#v(0.12cm)

Squash (compétition) · Voile (loisir)
